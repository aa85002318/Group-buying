...
export function MoreProductsCard({
  ...
  return (
    <Link
      href={href}
      className={`ingredient-shop-card ingredient-shop-more-card group relative flex min-h-[220px] shrink-0 snap-start flex-col items-center justify-center self-stretch overflow-hidden rounded-2xl border border-[#E9EDF2] bg-[#EEF8FC] p-2.5 shadow-[0_5px_16px_rgba(21,62,115,0.05)] transition duration-300 md:p-3 md:hover:-translate-y-0.5 md:hover:shadow-[0_8px_20px_rgba(21,62,115,0.08)] ${PRODUCT_RAIL_CARD_WIDTH}`}
    >
