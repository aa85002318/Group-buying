...
export const CMS_PAGE_REGISTRY: CmsPageRegistryEntry[] = [
  {
    ...
    pageType: "home",
    previewPath: "/",
    editHref: "/admin/page-builder/desktop/home",
    categoryGroup: "首頁",
    systemRequired: true,
    hasLayoutCms: true,
    adapter: "home",
  ...
  },
  {
    ...
    pageType: "shop",
    previewPath: "/shop",
    editHref: "/admin/page-builder/desktop/shop",
    categoryGroup: "商城",
    systemRequired: true,
    hasLayoutCms: true,
    adapter: "shop",
  ...
  },
  {
    ...
    editHref: "/admin/page-builder/desktop/category",
    categoryGroup: "商品",
    hasLayoutCms: false,
    adapter: "none",
  ...
  },
  {
    ...
    editHref: "/admin/page-builder/desktop/product_template",
    categoryGroup: "商品",
    hasLayoutCms: false,
    adapter: "none",
  ...
  },
  {
    ...
    pageType: "recipes",
    previewPath: "/recipes",
    editHref: "/admin/page-builder/desktop/recipes",
    categoryGroup: "食譜",
    hasLayoutCms: true,
    adapter: "recipes",
  ...
  },
  {
    ...
    previewPath: "/recipes",
    editHref: "/admin/page-builder/desktop/recipe_category",
    categoryGroup: "食譜",
    hasLayoutCms: false,
    adapter: "none",
  },
  {
    ...
    previewPath: "/recipes",
    editHref: "/admin/page-builder/desktop/recipe_template",
    categoryGroup: "食譜",
    hasLayoutCms: false,
    adapter: "none",
  ...
  },
  {
    ...
    editHref: "/admin/page-builder/desktop/group_buy",
    categoryGroup: "團購",
    systemRequired: true,
    hasLayoutCms: true,
    adapter: "group_buy",
  },
  {
    ...
    pageType: "member",
    previewPath: "/member",
    editHref: "/admin/page-builder/desktop/member",
    categoryGroup: "會員",
    hasLayoutCms: false,
    adapter: "none",
  },
  {
    ...
    previewPath: "/shop",
    editHref: "/admin/page-builder/desktop/ai_assistant",
    categoryGroup: "AI 功能",
    hasLayoutCms: false,
    adapter: "none",
  ...
  },
  {
    ...
    editHref: "/admin/page-builder/desktop/article",
    categoryGroup: "活動與內容",
    hasLayoutCms: false,
    adapter: "none",
  },
  {
    ...
    previewPath: "/",
    editHref: "/admin/page-builder/desktop/global_header",
  ...
  },
  {
    ...
    pageType: "global_component",
    previewPath: "/",
    editHref: "/admin/page-builder/desktop/global_side_menu",
    categoryGroup: "全站共用元件",
    systemRequired: true,
    hasLayoutCms: false,
    adapter: "chrome",
  },
  {
    ...
    pageType: "global_component",
    previewPath: "/",
    editHref: "/admin/page-builder/desktop/global_bottom_nav",
    categoryGroup: "全站共用元件",
    systemRequired: true,
    hasLayoutCms: false,
    adapter: "chrome",
  },
  {
    ...
    pageType: "global_component",
    previewPath: "/",
    editHref: "/admin/page-builder/desktop/global_footer",
    categoryGroup: "全站共用元件",
    systemRequired: true,
    hasLayoutCms: false,
    adapter: "chrome",
  },
  {
    ...
    editHref: "/admin/page-builder/desktop/activities",
    categoryGroup: "活動與內容",
    hasLayoutCms: false,
    adapter: "none",
  ...
  },
  {
    ...
    pageType: "article",
    previewPath: "/themes",
    editHref: "/admin/page-builder/desktop/brands",
    categoryGroup: "活動與內容",
    hasLayoutCms: false,
    adapter: "none",
  ...
  },
  {
    ...
    pageType: "custom",
    previewPath: "/stores",
    editHref: "/admin/page-builder/desktop/stores",
    categoryGroup: "活動與內容",
    hasLayoutCms: false,
    adapter: "none",
  },
  {
    ...
    editHref: "/admin/page-builder/desktop/orders",
    categoryGroup: "會員",
    hasLayoutCms: false,
    adapter: "none",
  ...
  },
  {
    ...
    editHref: "/admin/page-builder/desktop/favorites",
    categoryGroup: "會員",
    hasLayoutCms: false,
    adapter: "none",
  },
  {
    ...
    pageType: "custom",
    previewPath: "/cart",
    editHref: "/admin/page-builder/desktop/cart",
    categoryGroup: "商城",
    hasLayoutCms: false,
    adapter: "none",
  ...
  },
  {
    ...
    editHref: "/admin/page-builder/desktop/checkout",
    categoryGroup: "商城",
    hasLayoutCms: false,
    adapter: "none",
  ...
  },
  {
    ...
    editHref: "/admin/page-builder/desktop/shopping_guide",
    categoryGroup: "活動與內容",
    hasLayoutCms: false,
    adapter: "none",
  },
  {
    ...
    editHref: "/admin/page-builder/desktop/shipping",
    categoryGroup: "活動與內容",
    hasLayoutCms: false,
    adapter: "none",
  },
  {
    ...
    pageType: "custom",
    previewPath: "/faq",
    editHref: "/admin/page-builder/desktop/faq",
    categoryGroup: "活動與內容",
    hasLayoutCms: false,
    adapter: "none",
  },
  {
    ...
    pageType: "custom",
    previewPath: "/about",
    editHref: "/admin/page-builder/desktop/about",
    categoryGroup: "活動與內容",
    hasLayoutCms: false,
    adapter: "none",
  },
  {
    ...
    pageType: "custom",
    previewPath: "/contact",
    editHref: "/admin/page-builder/desktop/contact",
    categoryGroup: "活動與內容",
    hasLayoutCms: false,
    adapter: "none",
  },
