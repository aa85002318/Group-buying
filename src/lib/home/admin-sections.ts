...
const LEGACY_HOME_ADMIN_SECTIONS: HomeAdminSectionMeta[] = [
  ...
  },
  {
    id: "ai_assistant",
    label: "AI 烘焙助手",
    description: "AI 搜尋入口區塊。若草稿尚無此區可加入。",
    contentMode: "manual",
    catalog: true,
  },
  {
  ...
  },
  {
    ...
    label: "本週優惠 Banner",
    description: "可加入多組優惠 Banner 帶；建議橫幅圖 2:1 或 5:2。",
    contentMode: "banners",
    catalog: true,
  },
  {
    id: "banner_strip",
    label: "自訂 Banner 帶",
    description: "可重複新增；每組可設 placement。適用活動橫幅列。",
    contentMode: "banners",
