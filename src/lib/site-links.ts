...
export const APP_ROUTES = {
  ...
  memberSubscriptions: "/member/settings/subscriptions",
  memberLineSettings: "/member/settings/line",
  memberPreferredStore: "/member/settings/preferred-store",
  memberPhoneChange: "/member/settings/phone",
  memberPrivacyConsents: "/member/settings/consents",
  memberDataExport: "/member/settings/data-export",
  memberLoginDevices: "/member/settings/devices",
...
const LINK_META: Record<AppRouteKey, { label: string; description?: string }> = {
  ...
  memberGiftsMy: { label: "我的兌換券（別名）", description: "導向 /member/benefits/vouchers" },
  ...
  memberSubscriptions: { label: "行銷與訂閱", description: "行銷訊息與訂閱偏好" },
  memberLineSettings: { label: "LINE 綁定", description: "綁定或解除 LINE 帳號" },
  memberPreferredStore: { label: "預設取貨門市", description: "偏好取貨門市設定" },
  memberPhoneChange: { label: "變更手機", description: "手機號碼變更與驗證" },
  memberPrivacyConsents: { label: "同意紀錄", description: "隱私權與會員條款同意" },
  memberDataExport: { label: "個資下載", description: "查詢與下載個人資料" },
  memberLoginDevices: { label: "登入裝置", description: "裝置管理與異常登入保護" },
  memberStores: { label: "門市資訊", description: "取貨門市地址與營業時間" },
  forgotPassword: { label: "忘記密碼", description: "寄送重設密碼連結" },
  resetPassword: { label: "重設密碼", description: "設定新的登入密碼" },
