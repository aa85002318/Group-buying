...
/** @deprecated Cards size from 1:1 image + body; kept for call sites that still import it. */
...
/** Full-bleed 1:1 thumbnail (edge-to-edge within the card). */
export const PRODUCT_RAIL_IMAGE_FRAME =
  "relative block aspect-square w-full shrink-0 overflow-hidden bg-[#F4F6F8]";
...
export const PRODUCT_RAIL_SKELETON = [
  "home-skeleton shrink-0 rounded-2xl aspect-[5/8]",
  PRODUCT_RAIL_CARD_WIDTH,
].join(" ");
