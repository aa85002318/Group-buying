...
/** Match homepage hero display: full-bleed art without bottom feature strip. */
export const SHOP_HERO_DESKTOP_WIDTH = 1024;
export const SHOP_HERO_DESKTOP_HEIGHT = 839;
export const SHOP_HERO_MOBILE_WIDTH = 1024;
export const SHOP_HERO_MOBILE_HEIGHT = 839;
...
export const DEFAULT_SHOP_HERO_BANNERS: ShopHeroBanner[] = [
  {
    ...
    desktop_image: "/images/shop/hero-desktop.jpg?v=20260802d",
    mobile_image: "/images/shop/hero-mobile.jpg?v=20260802d",
