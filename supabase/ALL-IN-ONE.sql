-- =============================================================================
-- 門市團購 APP — ALL-IN-ONE（完整 Schema + 種子資料）
-- =============================================================================
--
-- 本檔案合併兩個區段，可一次執行或分段執行：
--   區段 1：complete-schema.sql（全新安裝，含 DROP CASCADE）
--   區段 2：seed-data.sql（範例資料，ON CONFLICT DO NOTHING）
--
-- 建議：開發環境可一次 Run；正式環境請改用 supabase/migrations/ 增量遷移。
-- 詳細說明請見 supabase/README-SQL.md
-- 後台指南請見 docs/ADMIN-GUIDE.md
-- =============================================================================


-- =============================================================================
-- 區段 1：完整 Schema（fresh install）
-- 來源：supabase/complete-schema.sql
-- =============================================================================
