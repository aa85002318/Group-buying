-- =============================================================================
-- 門市團購 APP — 正式部署完整 SQL（一鍵執行版）
-- =============================================================================
--
-- 【適用情境】全新 Supabase 專案，或開發環境重置
--
-- 【使用方式】
-- 1. Supabase Dashboard → SQL Editor
-- 2. 貼上本檔全部內容 → Run
-- 3. （選用）再執行 supabase/seed-data.sql 建立範例門市／商品
--
-- 【組成】
--   Part 1  complete-schema.sql     基礎 30 張表 + RLS + Auth 觸發器
--   Part 2  小怪獸遊戲表
--   Part 3  商品多圖、首頁精選團購
--   Part 4  文章、分類圖示
--   Part 5  正式部署 Phase 1（取貨碼、金流、物流、門市人員、RLS）
--
-- ⚠️  Part 1 含 DROP CASCADE，會刪除 public 內所有業務資料後重建。
--     已有正式資料的專案請勿執行本檔，改執行 supabase/INCREMENTAL-ONLY.sql
-- =============================================================================

-- ########## Part 1: complete-schema.sql ##########
-- =============================================================================
...
-- ########## Part 3: product_images_homepage_featured ##########
-- 商品多圖與首頁輪播精選團購欄位
...
-- ########## Part 4: articles_categories_icons ##########
-- 文章、分類圖示、商品預購欄位
